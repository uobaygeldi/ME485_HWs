...
# square
p6 = gmsh.model.geo.addPoint(0.35, -0.75, 0, lc)  # x: 0.35, y: -0.75
p7 = gmsh.model.geo.addPoint(0.55, 0.4, 0, lc)    # x: 0.55, y: 0.4
p8 = gmsh.model.geo.addPoint(-0.7, 0.6, 0, lc)    # x: -0.7, y: 0.6
p9 = gmsh.model.geo.addPoint(-0.4, -0.35, 0, lc)  # x: -0.4, y: -0.35
...
gmsh.model.geo.mesh.setTransfiniteCurve(l11, 5)
gmsh.model.geo.mesh.setTransfiniteCurve(l12, 5)
