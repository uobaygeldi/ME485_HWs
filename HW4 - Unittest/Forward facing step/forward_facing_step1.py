...
p2  = gmsh.model.geo.addPoint( 6,0, 0,lc);

p3  = gmsh.model.geo.addPoint( 6,1, 0,lc);

p4  = gmsh.model.geo.addPoint( 16,1, 0,lc);
...
gmsh.model.addPhysicalGroup(1, [l6],       12 , name="inflow")
gmsh.model.addPhysicalGroup(1, [l1,l2 ,l3,l5], 13 , name="wall")
gmsh.model.addPhysicalGroup(2, [s1],14 , name="fluid")

# Save it to disk
gmsh.model.mesh.generate(2)
gmsh.write("forward1.msh")
